...
class FullBatchItemToItemSampler(IterableDataset):
    def __init__(self, g, user_type, item_type):
        self.g = g
    ...
    def __iter__(self):
        heads = torch.arange(self.g.num_nodes(self.item_type))
        ...
        neg_tails = torch.randint(
            0, self.g.num_nodes(self.item_type), (heads.shape[0],)
        )
